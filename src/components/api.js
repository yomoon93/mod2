...
class Api extends React.Component {
  ...
  property = () => {
    fetch(
      "https://zillow-com1.p.rapidapi.com/property_url=" + this.props.city,
      {
        method: "GET",
        headers: {
          ...
          return (
            <div key={key} className="main-box">
              <li className="box">
                ...
                <br />
                <div className="property"> Bedrooms: {data.bedrooms} </div>
                <br />
                <div className="property"> Bathrooms: {data.bathrooms} </div>
                <br />
                ...
                <button className="btn-main"
                  id="btnb"
                  onClick={(e) => this.handleImage(e, data.zpid)}
                >
                  Show Image
                </button>
                </div>
              ...
              {data.url && data.show ? (
                <img id="photo" onClick={data.url} alt="pix" src={data.url} />
              ) : (
                ""
              )}
